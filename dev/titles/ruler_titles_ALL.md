...
# ============================================================
# ARDRAINIC (Old French medieval + Arthurian)
# ============================================================
# Base dialect: Ardrainien (standard court French)
# Design: real Old French titles with light Ardrainic phonetic twist
# Dialect shifts follow the same rules as name transforms (config.yaml)
...
| Dialect        | Emperor    | Empress      |
|----------------|------------|--------------|
| Ardrainien     | Empereor   | Empereis     |
| Sittadellian   | Empereort  | Emperist     |
| Aullerican     | Empereour  | Emperaeis    |
| Aloisoise      | Empereoren | Empereiser   |
| Caprainois     | Emperorel  | Empereil     |
| Pwasciards     | Empero     | Emperi       |
| Serenish       | Emporor    | Emporois     |
| Berenguer      | Emperort   | Emperein     |
| Draquatin      | Emperoun   | Emperouna    |
| Chevallois     | Empereourt | Emperoise    |
| Appavin        | Emperoret  | Empereiset   |

## Kingdom — all dialects

| Dialect        | King       | Queen        |
|----------------|------------|--------------|
| Ardrainien     | Reis       | Reinore      |
| Sittadellian   | Reist      | Reinort      |
| Aullerican     | Raeis      | Reinoer      |
| Aloisoise      | Reiser     | Reinoren     |
| Caprainois     | Rais       | Reinorel     |
| Pwasciards     | Re         | Reino        |
| Serenish       | Rois       | Reinor       |
| Berenguer      | Rein       | Reinort      |
| Draquatin      | Rei        | Reinouna     |
| Chevallois     | Reault     | Reinourt     |
| Appavin        | Reit       | Reinoret     |

## Duchy — all dialects

| Dialect        | Duke       | Duchess      |
|----------------|------------|--------------|
| Ardrainien     | Dus        | Ducesse      |
| Sittadellian   | Dust       | Ducest       |
| Aullerican     | Dues       | Ducaesse     |
| Aloisoise      | Duser      | Ducessen     |
| Caprainois     | Duis       | Ducelle      |
| Pwasciards     | Du         | Duces        |
| Serenish       | Dus        | Ducosse      |
| Berenguer      | Duz        | Ducenn       |
| Draquatin      | Dous       | Ducessa      |
| Chevallois     | Dault      | Ducoise      |
| Appavin        | Duet       | Ducesset     |
...
# ============================================================
# TORRENT (Germanic archaique)
# ============================================================
# Base dialect: Heuhian (standard heartland)
# Design: recognizable Germanic ROOT + Torrent morpheme compound
# Each dialect has a SIGNATURE MORPHEME or STRUCTURAL CHANGE
# CRITICAL: Borrikan/Tyelkian/Chesmeker are ALL GERMANIC (not Slavic/Hungarian/Turkic)

## Base titles

| Rank    | Ruler M     | Ruler F      | Etymology                              |
|---------|-------------|--------------|----------------------------------------|
| Empire  | Kaisarmund  | Kaisarmunde  | Kaisar (Caesar) + mund (protector)     |
| Kingdom | Kunig       | Kunigin      | Middle High German archaic for Koenig  |
| Duchy   | Herzgar     | Herzgarde    | Herz (army, from Herzog) + gar (spear) |
| County  | Grafvarn    | Grafvarne    | Graf (judge) + varn (guardian)          |

## Dialect signature morphemes

| Dialect       | Signature                               |
|---------------|-----------------------------------------|
| Heuhian       | Base: -mund, -gar, -varn                |
| Fullhorner    | ae vowels + archaic: -maend, -waeld     |
| Afhaemeisan   | Softened: -vald everywhere              |
| Lower Serenic | Hardened: -hart, -gaert, -walt          |
| Middle Serenic| Ardrainic infiltration: -vain           |
| Sorlkol       | Mountain a->o: -stein, -mond            |
| Naurmen       | Elongated: -maar (merchant glory)       |
| Stedeling     | Elongated: -rik (urban power)           |
| Thaurfolk     | Norse roots: All-, Drot-, Hert-, Jarl   |
| Bonwesforian  | Fire/sword: -brand                      |
| Borrikan      | VOICED K->G, S->Z, F->V (Germanic!)    |
| Tyelkian      | REVERSED compound + fronted vowels      |
| Chesmeker     | GUTTURAL Kh-/Gh- aspiration (Germanic!) |

## Empire — all dialects

| Dialect        | Emperor       | Empress        |
|----------------|---------------|----------------|
| Heuhian        | Kaisarmund    | Kaisarmunde    |
| Fullhorner     | Kaisaermaend  | Kaisaermaende  |
| Afhaemeisan    | Kaisarvald    | Kaisarvalde    |
| Lower Serenic  | Kaisarhart    | Kaisarharde    |
| Middle Serenic | Kaisarvain    | Kaisarvaine    |
| Sorlkol        | Koisorstein   | Koisorsteine   |
| Naurmen        | Kaaisaarmaar  | Kaaisaarmaare  |
| Stedeling      | Kaaisaarrik   | Kaaisaarrike   |
| Thaurfolk      | Alljar        | Alljarde       |
| Bonwesforian   | Kaisarbrand   | Kaisarbrande   |
| Borrikan       | Gaizarmund    | Gaizarmunde    |
| Tyelkian       | Muendkaisar   | Muendkaisarin  |
| Chesmeker      | Khaisarvarn   | Khaisarvarne   |

## Kingdom — all dialects

| Dialect        | King          | Queen          |
|----------------|---------------|----------------|
| Heuhian        | Kunig         | Kunigin        |
| Fullhorner     | Kunewald      | Kunewalde      |
| Afhaemeisan    | Kunivald      | Kunivalde      |
| Lower Serenic  | Kunighart     | Kunigharde     |
| Middle Serenic | Kunivain      | Kunivaine      |
| Sorlkol        | Konigmond     | Konigmonde     |
| Naurmen        | Kuuningmaar   | Kuuningmaare   |
| Stedeling      | Kuuningrik    | Kuuningrike    |
| Thaurfolk      | Drotjar       | Drotjarde      |
| Bonwesforian   | Kuningbrand   | Kuningbrande   |
| Borrikan       | Gunigard      | Gunigarde      |
| Tyelkian       | Valdkuenig    | Valdkuenigin   |
| Chesmeker      | Khunigvarn    | Khunigvarne    |

## Duchy — all dialects

| Dialect        | Duke          | Duchess        |
|----------------|---------------|----------------|
| Heuhian        | Herzgar       | Herzgarde      |
| Fullhorner     | Herzwaeld     | Herzwalde      |
| Afhaemeisan    | Herzvald      | Herzvalde      |
| Lower Serenic  | Herzgaert     | Herzgaerte     |
| Middle Serenic | Herzvain      | Herzvaine      |
| Sorlkol        | Herzmond      | Herzmonde      |
| Naurmen        | Heerzmaar     | Heerzmaare     |
| Stedeling      | Heerzrik      | Heerzrike      |
| Thaurfolk      | Hertjar       | Hertjarde      |
| Bonwesforian   | Herzbrand     | Herzbrande     |
| Borrikan       | Herdzgar      | Herdzgarde     |
| Tyelkian       | Gaerherz      | Gaerherzin     |
| Chesmeker      | Kherzgar      | Kherzgarde     |

## County — all dialects

| Dialect        | Count         | Countess       |
|----------------|---------------|----------------|
| Heuhian        | Grafvarn      | Grafvarne      |
| Fullhorner     | Grafvaern     | Grafvaerne     |
| Afhaemeisan    | Grafvald      | Grafvalde      |
| Lower Serenic  | Grafwalt      | Grafwalte      |
| Middle Serenic | Grafvain      | Grafvaine      |
| Sorlkol        | Grofmond      | Grofmonde      |
| Naurmen        | Graafmaar     | Graafmaare     |
| Stedeling      | Graafrik      | Graafrike      |
| Thaurfolk      | Jarl          | Jarle          |
| Bonwesforian   | Grafbrand     | Grafbrande     |
| Borrikan       | Gravvarn      | Gravvarne      |
| Tyelkian       | Varngraf      | Varngrafin     |
| Chesmeker      | Ghrafvarn     | Ghrafvarne     |
...
# Design: Italian city-state political vocabulary + Sordrenic markers (-tz, -enc, -onda, -enca)
# NOT French-derived — uses Italian/Mediterranean roots to avoid Ardrainic overlap

## Base titles

| Rank    | Ruler M     | Ruler F      | Etymology                                  |
|---------|-------------|--------------|---------------------------------------------|
| Empire  | Excelsatz   | Excelsonda   | eccelso (exalted) + -tz / -onda             |
| Kingdom | Signorenc   | Signoronda   | Signore (lord) + -enc / -onda               |
| Duchy   | Podestatz   | Podestenca   | podesta (magistrate) + -tz / -enca          |
| County  | Consolenc   | Consolenca   | console (consul) + -enc / -enca             |

## Empire — all dialects

| Dialect        | Emperor      | Empress        | Shift                          |
|----------------|--------------|----------------|--------------------------------|
| Salt Sordrenic | Excelsatz    | Excelsonda     | base                           |
| Stone Sordrenic| Excolsortz   | Excolsorda     | e->o, -tz->-rtz, -onda->-orda  |
| Lutin          | Excelsiatz   | Excelsionda    | "i" liquide elfique            |
| Pantagrin      | Excolsontz   | Excolsonda     | e->o, -tz->-ntz, lourd         |

## Kingdom — all dialects

| Dialect        | King         | Queen          | Shift                          |
|----------------|--------------|----------------|--------------------------------|
| Salt Sordrenic | Signorenc    | Signoronda     | base                           |
| Stone Sordrenic| Signororc    | Signororda     | -enc->-orc, -onda->-orda       |
| Lutin          | Signorienc   | Signorionda    | "i" liquide                    |
| Pantagrin      | Signorronc   | Signorronda    | -enc->-onc, consonnes doublees |

## Duchy — all dialects

| Dialect        | Duke         | Duchess        | Shift                          |
|----------------|--------------|----------------|--------------------------------|
| Salt Sordrenic | Podestatz    | Podestenca     | base                           |
| Stone Sordrenic| Podestortz   | Podestorca     | -tz->-rtz, -enca->-orca        |
| Lutin          | Podestiatz   | Podestienca    | "i" liquide                    |
| Pantagrin      | Podestontz   | Podestonca     | -tz->-ntz, -enca->-onca        |

## County — all dialects

| Dialect        | Count        | Countess       | Shift                          |
|----------------|--------------|----------------|--------------------------------|
| Salt Sordrenic | Consolenc    | Consolenca     | base                           |
...
# ============================================================
# MORAN (Latin classique — Empire mort-vivant)
# ============================================================
# 0 dialectes — langue figee par la non-mort
# Design: PURE classical Latin. No fantasy, no corruption. Frozen.

| Rank    | Ruler M     | Ruler F      |
|---------|-------------|--------------|
| Empire  | Imperator   | Imperatrix   |
| Kingdom | Rex         | Regina       |
| Duchy   | Dux         | Ducissa      |
...
# ============================================================
# 0 dialectes — lingua franca
# Design: visibly CORRUPTED Moran Latin. Each title shows the degradation.
...
# ============================================================
# ARMONORICAN (Celtique — Gallois/Breton/Cornique)
# ============================================================
# 2 dialectes: Aggeuios (rural archaique) + Ebiam (urbain poli)
# Design: Celtic political vocabulary from different Celtic branches
# Aggeuios = archaic with exclusive markers (Rh-, dd, -ydd, gh)
# Ebiam = smoothed urban forms (Ll->L, Rh->R, dd->d, gh dropped)

## Hierarchy: Pendraig (dragon) > Brenin (king) > Tiern (lord) > Distain (steward)

| Rank    | Aggeuios M     | Aggeuios F      | Ebiam M    | Ebiam F     | Origin                      |
|---------|----------------|-----------------|------------|-------------|------------------------------|
| Empire  | Pennddraig     | Pennddraiges    | Pendraig   | Pendraiges  | pen+draig = chef-dragon      |
| Kingdom | Brenhydd       | Brenhyddes      | Brenin     | Brenhines   | gallois brenin = roi         |
| Duchy   | Tighern        | Tighernes       | Tiern      | Tiernes     | breton *tigernos = seigneur  |
| County  | Rhyddystain    | Rhyddystaines   | Distain    | Distaines   | gallois distain = intendant  |

## What Ebiam smooths:
# nn->n, dd->d (Pennddraig -> Pendraig)
# -ydd->-in (Brenhydd -> Brenin)
...
| Rank    | Ruler M     | Ruler F       | Etymology                                |
|---------|-------------|---------------|------------------------------------------|
| Empire  | Arkayakh    | Arkoukht      | arqa (roi supreme) + -akh/-oukht geant   |
| Kingdom | Tagavor     | Tagouhi       | armenien pur = porteur de couronne       |
| Duchy   | Ishkhan     | Ishkhanoush   | armenien = prince/duc + -oush geant F    |
| County  | Nakharar    | Nakhrouhi     | armenien = seigneur feodal + -ouhi dame  |
